...
import 'package:modu_test_with_staggered/screens/service/components/service_line_chart_2.dart';
    ...
    return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        children: const [
                          Icon(Icons.add_circle, color: Colors.grey,size: 32.0,),
                          SizedBox(width: 5),
                          Text('담당자 추가/관리')
                        ],
                      ),
